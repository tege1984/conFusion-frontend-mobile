       ...
       $scope.takePicture = function() {
        ...
        $cordovaImagePicker.getPictures(options)
          .then(function (imageURI) {
            $scope.registration.imgSrc =  imageURI;
...
.controller('MenuController', ['$scope', 'dishes','favoriteFactory',
        ...
        .controller('DishDetailController', ['$scope', '$stateParams','dish', 'menuFactory',
                    ...
                    function($scope, $stateParams, dish, menuFactory,favoriteFactory,
                     baseURL, $ionicPopover,$ionicModal,$timeout, $ionicPlatform,
            ...
            $scope.addDishComment = function() {
              ...
              console.log('Dish comment', $scope.dishCommentData);

              $scope.dishCommentData.date = new Date().toISOString();
              console.log($scope.dishCommentData);

              $scope.dish.comments.push($scope.dishCommentData);
              menuFactory.update({id:$scope.dish.id},$scope.dish);

              // Simulate a dish comment  delay. Remove this and replace with your dish comment
              // code if using a dish comment system
              $timeout(function() {
        ...
        '$ionicLoading', '$timeout','$cordovaVibration', function ($scope, dishes, favorites, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout, $cordovaVibration) {
